...
Now that we have created our basic role in [part 1]({% post_url 2015-03-14-testing-ansible-roles-rolespec-vagrant %}), we need to set-up a Vagrant machine and some tooling to run our tests.
...
Now run `guard`, change a file, and see what happens.
